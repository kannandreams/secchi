...
def test_project_report_contains_sources_in_all_formats() -> None:
    ...
    assert "Generated by [Secchi](https://github.com/kannandreams/secchi)" in render_project_report("md", report)
    assert "1.2.3" in render_project_report("html", report)
    assert 'Generated by <a href="https://github.com/kannandreams/secchi">Secchi</a>' in render_project_report("html", report)
